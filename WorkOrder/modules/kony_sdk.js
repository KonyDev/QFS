...
kony.sdk.util.checkAndFetchNetworkProviderOptions = function (options) {
    ...
    if (!kony.sdk.isNullOrUndefined(options) && options["passthrough"]) {
        providerOptions["passthrough"] = options["passthrough"];
    }
