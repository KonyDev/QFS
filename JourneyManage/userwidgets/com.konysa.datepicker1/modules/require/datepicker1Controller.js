  ...
  return {
    ...
    onScrollEnd:function(){
      try
      {
        ...
        this.view.segDays.onScrollEnd=function(){
          this.view.segDays.selectedRowIndex=[0,Number(this.view.segDays.getFirstVisibleRow().rowIndex)];
        }.bind(this);

        this.view.segMonths.onScrollEnd=function(){
          //debugger;
          this.view.segMonths.selectedRowIndex=[0,Number(this.view.segMonths.getFirstVisibleRow().rowIndex)];
        ...
        this.view.segYears.onScrollEnd=function(){
          //debugger;
          this.view.segYears.selectedRowIndex=[0,Number(this.view.segYears.getFirstVisibleRow().rowIndex)];
          var currentSelectedMonthIndex=this.view.segMonths.getFirstVisibleRow().rowIndex+1;
          var currentSelectedMonth=this.view.segMonths.data[currentSelectedMonthIndex].lblDatePicker;
          var monthIndex=this.mapMonths(currentSelectedMonth);
          var currentSelectedYearIndex=this.view.segYears.getFirstVisibleRow().rowIndex+1;
    ...
    onDateSelected:function(){
      try
      {
        ...
        var dat = date;
        var toReturn = {};
        toReturn["year"] = ""+dat.getFullYear();
        var mL = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
        toReturn["month"] = ""+mL[dat.getMonth()];
        toReturn["date"] = ""+dat.getDate();
        toReturn["dateString"] = ""+(dat.getMonth()+1)+"/"+(dat.getDate())+"/"+dat.getFullYear();
        if(typeof this.onDateSelectionDone=='function'){
          this.onDateSelectionDone(toReturn); 
        }
      }
      catch(err)
      {
    ...
    invokePostShowForSettingtheValue:function()
    {
      //debugger;
    },
