define(['./KonyLogger'], function (KonyLoggerModule) {
	...
	NativeController.prototype.setYearData = function(){
			...
			var currentYearIndex = new Date().getFullYear() - this.componentInstance._startYear;
...
//               date + this.nth(parseInt(date)) + " " + this.componentInstance.view.segMonth.data[this.prevSelectedMonthIndex]['lblRow'].text + " " + this.componentInstance.view.segYear.data[this.prevSelectedYearIndex]['lblRow'].text;
	...
	NativeController.prototype.setDataForDatesSegment = function (year, month) {
		switch (new Date(year, month, 0).getDate()) {
			case 31:
				if (this.componentInstance.view.segDate.data.length !== this.dataFor31Days.length)
					this.componentInstance.view.segDate.setData(this.dataFor31Days);
				break;
			case 30:
				if (this.componentInstance.view.segDate.data.length !== this.dataFor30Days.length)
					this.componentInstance.view.segDate.setData(this.dataFor30Days);
				break;
			case 28:
				if (this.componentInstance.view.segDate.data.length !== this.dataFor28Days.length)
					this.componentInstance.view.segDate.setData(this.dataFor28Days);
				break;
			default:
				if (this.componentInstance.view.segDate.data.length !== this.dataFor29Days.length)
