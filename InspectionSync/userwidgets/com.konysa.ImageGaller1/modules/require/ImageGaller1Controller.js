define(function() {
  ...
  return {
     ...
     */
    setImage:function(response,responseType){
      debugger;
      var flxItem;
      var id=0;
      var fileName;
      ...
      if (responseType == "base64"){
              this.view.imgEvent.base64=firstImage;
      ...
      for(var i=0;i<response.length;i++){
            flxItem=this.getFlexItem(id,response[i],responseType);
     ...
     */
    getFlexItem:function(id,imagedata,responsetype){
      debugger;
      var self=this;
      function test(eventobject){
        ...
        if(responsetype == "base64"){
           var imageSrc=self.view["imgThumb"+id[1]].base64;
           self.view.imgEvent.base64=imageSrc;
        }
        else{
