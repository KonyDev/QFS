define({
    ...
    */
    ...
    AS_FlexContainer_c651835d7999481da0b759f16ac6510e: function AS_FlexContainer_c651835d7999481da0b759f16ac6510e(eventobject) {
        var self = this;
        this.invokeTouchID();
    },
    ...
    AS_TextField_c23bbbcc9e324f269b45de71bb65ef86: function AS_TextField_c23bbbcc9e324f269b45de71bb65ef86(eventobject, changedtext) {
        var self = this;
        this.onDoneCredentials(this.view.lblUsername);
    },
    /** onDone defined for tbxPassword **/
    AS_TextField_j9781f06725447b99b8c5b12a291ddd3: function AS_TextField_j9781f06725447b99b8c5b12a291ddd3(eventobject, changedtext) {
        var self = this;
        this.onDoneCredentials(this.view.lblPassword);
    },
    /** onClick defined for flxRememberMe **/
    AS_FlexContainer_a818be9aeef34c50a3bbfbe61630a132: function AS_FlexContainer_a818be9aeef34c50a3bbfbe61630a132(eventobject) {
        var self = this;
        this.remembermeSelection();
    },
    /** onClick defined for btnLogin **/
    AS_Button_j3d8c3c3048e496f8c1247d3362a1d79: function AS_Button_j3d8c3c3048e496f8c1247d3362a1d79(eventobject) {
        var self = this;
        this.invokeButtonClick();
    },
    /** onClick defined for flxLblUsername **/
    AS_FlexContainer_jc734d482aeb419884a34465bce686e2: function AS_FlexContainer_jc734d482aeb419884a34465bce686e2(eventobject) {
        var self = this;
    ...
    AS_FlexContainer_e67c81675ecf4ac9b535b24785b64f78: function AS_FlexContainer_e67c81675ecf4ac9b535b24785b64f78(eventobject) {
        var self = this;
