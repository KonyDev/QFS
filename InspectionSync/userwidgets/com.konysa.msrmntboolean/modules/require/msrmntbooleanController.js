  ...
  return {
    ...
    toggleSelection:function(eventobject){
      ...
      //if(this._selectedItem==="flxItem0"){
        this.view.imgToggle1.src="radio_buttion_inactive.png";
        this.view.imgToggle0.src="radio_buttion_active.png";
        this._value= this.view.lblItem0.text;
        this._selectedItem="flxItem0";
      }else if(id==="flxItem1"){
        this.view.imgToggle1.src="radio_buttion_active.png";
        this.view.imgToggle0.src="radio_buttion_inactive.png";
