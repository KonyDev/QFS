define({ 
  ...
  onNavigate:function(data){
    ...
    if(data===null||data===undefined)
      ...
      if(!kony.sdk.isNullOrUndefined(data.previousForm) && data.previousForm =="frmInspectionHistory")
        return;
    }
    this.count=0;
    ...
    this.assetDetail = inspection.asset;
  ...
  onFormPostShow:function(){
    ...
    try{
      if(typeof this.navigationData==='object' &&  this.navigationData!==null){
        ...
        if(this.navigationData.previousForm==="frmInspectionsList"){
          this.setInspectionHistoryData(this.navigationData);
        }else if(this.navigationData.previousForm==="frmInspectionExecution"){
          this.enableReviewMode();
          this.setCapturedInspection(this.navigationData);
          this.populateAssetDetail(this.assetDetail);
        }
      }
    }catch(excp){
      debugger;
  ...
  setCommonData:function(inspection){
    if(typeof inspection==='object' &&  inspection !==null){
      ...
      if(typeof asset==='object' &&  asset!==null){
        ...
        this.view.imgAsset.base64 = asset["image_base64"];
      }else{
        this.view.lblAssetNameValue.text="NA";
      }
    }
  ...
  updateInspection:function(inspectionObj){
    ...
    try{
      ...
      var record={
        ...
        "Submission_Timestamp":currentDateTime
      };
      var options={};
  ...
  setCapturedImage:function(measurement){
    ...
    if(Array.isArray(measurement) && measurement.length>0 ){
      ...
      this._imageBase64Arr = imgBase64Arr;
  ...
  getInspectedData:function(inspectionData){
    ...
    if(typeof inspectionData==='object' &&  inspectionData!==null){
      ...
      if(typeof inspection==='object' &&  inspection!==null){
        ...
        var signa=this.view.signaturepad.getSignature();
  ...
  submitInspectionSuccessCB:function(result){
    ...
    //     }
    try{
      var navObj=new kony.mvc.Navigation("frmInspectionConfirmation");
      var inspectionId = this.view.lblInspectionIDValue.text;
      navObj.navigate(inspectionId);
    }catch(excp){
      alert(JSON.stringify(excp));
    }
    //alert(result);
  ...
  getFlexImageItem:function(id,imageBase64){
     ...
     *
     */
    function procesImgData(){
      this.view.ImageGaller1.setImage(this._imageBase64Arr, "base64");
    ...
    var flxImageItem0 = new kony.ui.FlexContainer({
      ...
      "width": "80dp",
      "zIndex": 1,
      "onClick":procesImgData.bind(this)
    }, {}, {});
  ...
  navigateBack:function(){
    if(typeof this.navigationData==='object' &&  this.navigationData!==null ){
      ...
      //       var lastFormName=this.navigationData["previousForm"];
      //       if(typeof lastFormName==='string'){
      try{
        var navObj=new kony.mvc.Navigation(this.navigationData["previousForm"]);
  ...
  onPostShow:function(){
    ...
    kony.net.setNetworkCallbacks(config);*/
    return;
    //     if(this._inspection===null||this._inspection===undefined)
    //       return;
    //     else if(kony.sdk.isNullOrUndefined(this.assetDetail)){
    ...
    if(typeof this.navigationData==='object' &&  this.navigationData!==null){
      ...
      if(typeof inspection==='object' &&  inspection!==null){
        ...
        if(typeof assetId==='string' || typeof assetId==='number'){
          ...
          if(!kony.sdk.isNullOrUndefined(this.navigationData.previousForm) && this.navigationData.previousForm =="frmInspectionsList"){
            navigationData.image_base64 = this.navigationData.inspection.asset.image_base64;
          }
          else{
            navigationData.image_base64 = this.navigationData.assetDetail.image_base64;
          }
